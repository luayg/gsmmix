...
use App\Http\Controllers\Admin\PageThemeController;
...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::prefix('finances')->name('finances.')->group(function () {
        ...
        Route::get('/invoices/payment/{payment}/print', [InvoiceController::class, 'printPayment'])->name('invoices.payments.print');
    ...
    Route::prefix('pages')->name('pages.')->group(function () {
        ...
        Route::delete('/themes/{theme}', [PageThemeController::class, 'destroy'])->name('themes.destroy');
