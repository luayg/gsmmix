...
final class PageThemeController extends Controller
{
    ...
    public function restoreOriginal(): RedirectResponse{PageTheme::query()->where('active',true)->update(['active'=>false]);return back()->with('ok','The original website theme has been restored. Your saved themes are still available.');}
