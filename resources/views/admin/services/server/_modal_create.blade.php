...
<form id="serviceCreateForm" action="{{ route('admin.services.server.store') }}" method="POST" data-ajax="1">
  @csrf
  <div class="row g-3">
    <div class="col-xl-7">
      <div class="row g-3">
        ...
        <div class="col-md-6"><label class="form-label mb-1">Type</label>
          <select name="type" class="form-select"><option value="server" selected>Server</option><option value="imei">IMEI</option><option value="file">File</option></select>
        </div>
        ...
        <div class="col-12">
          <div class="form-check form-switch"><input class="form-check-input" type="checkbox" name="active" value="1" id="s1"><label class="form-check-label" for="s1">Active</label></div>
          <div class="form-check form-switch"><input class="form-check-input" type="checkbox" name="allow_bulk" value="1" id="s2"><label class="form-check-label" for="s2">Allow bulk orders</label></div>
          <div class="form-check form-switch"><input class="form-check-input" type="checkbox" name="allow_duplicates" value="1" id="s3"><label class="form-check-label" for="s3">Allow duplicates</label></div>
        </div>
