...
<form id="serviceCreateForm"
  ...
  {{-- MAIN FIELD JSON -> server_services.main_field --}}
  ...
  {{-- Injected by service-modal logic --}}
      ...
      <div class="row g-3">
        ...
        <div class="col-xl-7">
          <div class="row g-3">
            ...
            {{-- ✅ SERVER: hide main field type UI (still keep values in hidden inputs) --}}
            ...
            <div class="col-md-6">
              ...
              <select name="type" class="form-select">
                <option value="imei" selected>Calculation</option>
...
(function(){
  ...
  function syncMainTypeHidden(){
    ...
    mainTypeHidden.value = mainFieldType.value || 'custom';
  }
  ...
  function buildMainFieldJson(){
    const type  = form.querySelector('#mainFieldType')?.value || 'custom';
    const label = form.querySelector('#mainFieldLabel')?.value || 'Custom';
  ...
  window.__serverServiceSetMainField__ = function(scope, type, label){
    try{
      ...
      if (labInp) labInp.value = l || 'Custom';
