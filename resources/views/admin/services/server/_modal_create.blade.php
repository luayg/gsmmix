      ...
      <div class="row g-3">
        ...
        <div class="col-md-6">
          ...
          <div class="input-group">
            <input type="text" class="form-control" data-role="price-preview" value="0.00" disabled>
        ...
        <div class="col-md-6">
          ...
          <div class="input-group">
            <input type="text" class="form-control" data-role="converted-price" value="0.00" disabled>
        ...
        <div class="col-md-6">
          ...
          <div class="input-group">
            <input name="profit" type="number" step="0.01" class="form-control" value="0.00">
            <select name="profit_type" class="form-select" style="max-width:130px">
        ...
        <div class="col-12 js-api-block">
          <div class="p-3 border rounded">
            ...
            <div class="mb-2">
              ...
              <select name="api_provider_id" class="form-select js-api-provider"></select>
            </div>
            <div class="mb-2">
        ...
        <div class="col-12">
          <div class="form-check form-switch">
            <input class="form-check-input" type="checkbox" name="active" value="1" id="s1">
